"use client";
const DinoScript = function () {
  function l(t, i) {
    if (l.instance_) return l.instance_;
    ((l.instance_ = this).outerContainerEl = document.querySelector(t)),
      (this.containerEl = null),
      (this.detailsButton =
        this.outerContainerEl.querySelector("#details-button")),
      (this.config = i || l.config),
      (this.dimensions = l.defaultDimensions),
      (this.canvas = null),
      (this.canvasCtx = null),
      (this.tRex = null),
  ...
  var e = 60,
    ...
    n =
      -1 < window.navigator.userAgent.indexOf("UIWebViewForStaticFileContent"),
    h = -1 < window.navigator.userAgent.indexOf("Mobi") || n;
  window;
  function o(t, i) {
  ...
  function c(t, i, s, e, n, h) {
    (this.canvasCtx = t),
      (this.image = s),
      (this.typeConfig = i),
      (this.gapCoefficient = n),
      (this.size = o(1, c.MAX_OBSTACLE_LENGTH)),
      (this.dimensions = e),
      (this.remove = !1),
      (this.xPos = 0),
  ...
  function d(t, i, s) {
    (this.canvas = t),
      ...
      (this.yPos = 0),
      (this.remove = !1),
      (this.cloudGap = o(d.config.MIN_CLOUD_GAP, d.config.MAX_CLOUD_GAP)),
      this.init();
  }
  function s(t, i) {
    (this.image = i),
  ...
  (l.config = {
    ...
    (l.prototype = {
      ...
      loadImages: function () {
        for (
          var t = T ? l.imageSources.HDPI : l.imageSources.LDPI,
            i = t.length - 1;
          0 <= i;
          i--
        ) {
          var s = t[i];
          this.images[s.name] = document.getElementById(s.id);
        }
        this.init();
      },
      loadSounds: function () {
        if (!n) {
          ...
          var t = document.getElementById(this.config.RESOURCE_TEMPLATE_ID);
          for (var i in l.sounds) {
            var s = t.children[l.sounds[i]].src,
              e = a((s = s.substr(s.indexOf(",") + 1)));
      ...
      init: function () {
        ...
        this.adjustDimensions(),
          ...
          (this.containerEl.className = l.classes.CONTAINER),
          (this.canvas =
            ((t = this.containerEl),
            (i = this.dimensions.WIDTH),
            (s = this.dimensions.HEIGHT),
            (e = l.classes.PLAYER),
            ((n = document.createElement("canvas")).className = e
              ? l.classes.CANVAS + " " + e
              : l.classes.CANVAS),
            (n.width = i),
            (n.height = s),
          ...
          this.canvasCtx.fill(),
          l.updateCanvasScaling(this.canvas),
          (this.horizon = new p(
            this.canvas,
            this.images,
            this.dimensions,
          ...
          (this.tRex = new C(this.canvas, this.images.TREX)),
          this.outerContainerEl.appendChild(this.containerEl),
          h && this.createTouchController(),
          this.startListening(),
          this.update(),
      ...
      createTouchController: function () {
        (this.touchController = document.createElement("div")),
          (this.touchController.className = l.classes.TOUCH_CONTROLLER);
      },
      ...
      update: function () {
        ...
        if (((this.time = t), this.activated)) {
          this.clearCanvas(),
            this.tRex.jumping && this.tRex.updateJump(i, this.config),
            (this.runningTime += i);
          var s = this.runningTime > this.config.CLEAR_TIME;
          1 != this.tRex.jumpCount || this.playingIntro || this.playIntro(),
            this.playingIntro
              ? this.horizon.update(0, this.currentSpeed, s)
              : ((i = this.started ? i : 0),
                this.horizon.update(i, this.currentSpeed, s)),
            s &&
            (function (t, i, s) {
              l.defaultDimensions.WIDTH, t.xPos;
              var e = new g(
                  i.xPos + 1,
                  i.yPos + 1,
                  i.config.WIDTH - 2,
              ...
              if (f(e, n))
                for (
                  var h = t.collisionBoxes, o = C.collisionBoxes, a = 0;
                  a < o.length;
                  a++
                )
      ...
      handleEvent: function (s) {
        ...
        }.bind(this)(s.type, l.events);
      },
      startListening: function () {
        document.addEventListener(l.events.KEYDOWN, this),
          document.addEventListener(l.events.KEYUP, this),
          h
            ? (this.touchController.addEventListener(l.events.TOUCHSTART, this),
              this.touchController.addEventListener(l.events.TOUCHEND, this),
              this.containerEl.addEventListener(l.events.TOUCHSTART, this))
            : (document.addEventListener(l.events.MOUSEDOWN, this),
              document.addEventListener(l.events.MOUSEUP, this));
      },
      stopListening: function () {
        document.removeEventListener(l.events.KEYDOWN, this),
          document.removeEventListener(l.events.KEYUP, this),
          h
            ? (this.touchController.removeEventListener(
                l.events.TOUCHSTART,
                this
              ),
              this.touchController.removeEventListener(l.events.TOUCHEND, this),
              this.containerEl.removeEventListener(l.events.TOUCHSTART, this))
            : (document.removeEventListener(l.events.MOUSEDOWN, this),
              document.removeEventListener(l.events.MOUSEUP, this));
      },
      onKeyDown: function (t) {
        t.target != this.detailsButton &&
          (this.crashed ||
            (!l.keycodes.JUMP[String(t.keyCode)] &&
              t.type != l.events.TOUCHSTART) ||
          ...
          this.crashed &&
            ...
            this.restart()),
          l.keycodes.DUCK[t.keyCode] &&
            this.tRex.jumping &&
            (t.preventDefault(), this.tRex.setSpeedDrop());
      },
      onKeyUp: function (t) {
        var i = String(t.keyCode),
          s =
            l.keycodes.JUMP[i] ||
            t.type == l.events.TOUCHEND ||
            t.type == l.events.MOUSEDOWN;
        if (this.isRunning() && s) this.tRex.endJump();
        else if (l.keycodes.DUCK[i]) this.tRex.speedDrop = !1;
        else if (this.crashed) {
          var e = r() - this.time;
          (l.keycodes.RESTART[i] ||
            (t.type == l.events.MOUSEUP && t.target == this.canvas) ||
            (e >= this.config.GAMEOVER_CLEAR_TIME && l.keycodes.JUMP[i])) &&
            this.restart();
        } else this.paused && s && this.play();
      },
      raq: function () {
        this.drawPending ||
          ((this.drawPending = !0),
      ...
      gameOver: function () {
        ...
        this.playSound(this.soundFx.HIT),
          (t = 200),
          h && window.navigator.vibrate && window.navigator.vibrate(t),
          this.stop(),
          (this.crashed = !0),
          (this.distanceMeter.acheivement = !1),
          this.tRex.update(100, C.status.CRASHED),
          this.gameOverPanel
            ? this.gameOverPanel.draw()
            : (this.gameOverPanel = new I(
                this.canvas,
                this.images.TEXT_SPRITE,
                this.images.RESTART,
                this.dimensions
      ...
      play: function () {
        this.crashed ||
          ((this.activated = !0),
          (this.paused = !1),
          this.tRex.update(0, C.status.RUNNING),
          (this.time = r()),
          this.update());
      },
      restart: function () {
        this.raqId ||
          ...
          (this.time = r()),
          this.containerEl.classList.remove(l.classes.CRASHED),
          this.clearCanvas(),
    ...
    (l.updateCanvasScaling = function (t, i, s) {
    ...
    (I.prototype = {
      ...
      draw: function () {
        var t = I.dimensions,
          ...
          m = this.canvasDimensions.HEIGHT / 2;
        T && ((e *= 2), (s *= 2), (n *= 2), (h *= 2), (d *= 2), (u *= 2)),
          this.canvasCtx.drawImage(this.textSprite, s, e, n, h, o, a, r, c),
    ...
    (c.MAX_GAP_COEFFICIENT = 1.5),
    (c.MAX_OBSTACLE_LENGTH = 3),
    (c.prototype = {
      init: function (t) {
        this.cloneCollisionBoxes(),
          1 < this.size && this.typeConfig.multipleSpeed > t && (this.size = 1),
      ...
      draw: function () {
        ...
        T && ((t *= 2), (i *= 2));
        var s = t * this.size * (0.5 * (this.size - 1));
        this.canvasCtx.drawImage(
          this.image,
          s,
          0,
      ...
      getGap: function (t, i) {
        ...
        return o(s, Math.round(s * c.MAX_GAP_COEFFICIENT));
      },
      isVisible: function () {
    ...
    (C.prototype = {
      init: function () {
        (this.blinkDelay = this.setBlinkDelay()),
          (this.groundYPos =
            l.defaultDimensions.HEIGHT -
            this.config.HEIGHT -
            l.config.BOTTOM_PAD),
          (this.yPos = this.groundYPos),
          (this.minJumpHeight = this.groundYPos - this.config.MIN_JUMP_HEIGHT),
          this.draw(0, 0),
          this.update(0, C.status.WAITING);
      },
      ...
      update: function (t, i) {
        (this.timer += t),
          i &&
            ((this.status = i),
            (this.currentFrame = 0),
            (this.msPerFrame = C.animFrames[i].msPerFrame),
            (this.currentAnimFrames = C.animFrames[i].frames),
            i == C.status.WAITING &&
              ((this.animStartTime = r()), this.setBlinkDelay())),
          this.playingIntro &&
      ...
      setBlinkDelay: function () {
        this.blinkDelay = Math.ceil(Math.random() * C.BLINK_TIMING);
      },
      blink: function (t) {
      ...
      startJump: function () {
        this.jumping ||
          (this.update(0, C.status.JUMPING),
      ...
      updateJump: function (t) {
        var i = t / C.animFrames[this.status].msPerFrame;
        this.speedDrop
      ...
      reset: function () {
        (this.yPos = this.groundYPos),
          (this.jumpVelocity = 0),
          (this.jumping = !1),
          this.update(0, C.status.RUNNING),
          (this.midair = !1),
          (this.speedDrop = !1),
          (this.jumpCount = 0);
      },
    ...
    (u.prototype = {
      ...
      calcXPos: function (t) {
        this.x =
          t - u.dimensions.DEST_WIDTH * (this.config.MAX_DISTANCE_UNITS + 1);
      },
      draw: function (t, i, s) {
        var e = u.dimensions.WIDTH,
          n = u.dimensions.HEIGHT,
          h = u.dimensions.WIDTH * i,
          o = t * u.dimensions.DEST_WIDTH,
          a = this.y,
          r = u.dimensions.WIDTH,
          c = u.dimensions.HEIGHT;
        if ((T && ((e *= 2), (n *= 2), (h *= 2)), this.canvasCtx.save(), s)) {
          var d =
            this.x - 2 * this.config.MAX_DISTANCE_UNITS * u.dimensions.WIDTH;
          this.canvasCtx.translate(d, this.y);
        } else this.canvasCtx.translate(this.x, this.y);
        this.canvasCtx.drawImage(this.image, h, 0, e, n, o, a, r, c),
        ...
        if (this.acheivement)
          this.flashIterations <= this.config.FLASH_ITERATIONS
            ...
            : ((this.acheivement = !1),
              (this.flashIterations = 0),
              (this.flashTimer = 0));
        else if (0 < (i = this.getActualDistance(i))) {
          i % this.config.ACHIEVEMENT_DISTANCE == 0 &&
            ((this.acheivement = !0), (e = !(this.flashTimer = 0)));
    ...
    (d.prototype = {
      init: function () {
        (this.yPos = o(d.config.MAX_SKY_LEVEL, d.config.MIN_SKY_LEVEL)),
          this.draw();
      },
      draw: function () {
        this.canvasCtx.save();
        var t = d.config.WIDTH,
          i = d.config.HEIGHT;
        T && ((t *= 2), (i *= 2)),
          this.canvasCtx.drawImage(
            this.image,
      ...
      isVisible: function () {
        return 0 < this.xPos + d.config.WIDTH;
      },
    }),
    (s.dimensions = {
      WIDTH: 600,
    ...
    (s.prototype = {
      setSourceDimensions: function () {
        for (var t in s.dimensions)
          T
            ? "YPOS" != t && (this.sourceDimensions[t] = 2 * s.dimensions[t])
            : (this.sourceDimensions[t] = s.dimensions[t]),
            (this.dimensions[t] = s.dimensions[t]);
        (this.xPos = [0, s.dimensions.WIDTH]), (this.yPos = s.dimensions.YPOS);
      },
      ...
      reset: function () {
        (this.xPos[0] = 0), (this.xPos[1] = s.dimensions.WIDTH);
      },
    }),
    (p.config = {
      BG_CLOUD_SPEED: 0.2,
    ...
    (p.prototype = {
      init: function () {
        this.addCloud(),
          (this.horizonLine = new s(this.canvas, this.horizonImg));
      },
      ...
      updateClouds: function (t, i) {
        ...
        if (e) {
          for (var n = e - 1; 0 <= n; n--) this.clouds[n].update(s);
      ...
      updateObstacles: function (t, i) {
        ...
        if (((this.obstacles = s), 0 < this.obstacles.length)) {
      ...
      addNewObstacle: function (t) {
        var i = o(0, c.types.length - 1),
          s = c.types[i],
          e = this.obstacleImgs[s.type];
        this.obstacles.push(
          new c(this.canvasCtx, s, e, this.dimensions, this.gapCoefficient, t)
        );
      },
      reset: function () {
      ...
      addCloud: function () {
        this.clouds.push(
          new d(this.canvas, this.cloudImg, this.dimensions.WIDTH)
        );
      },
    });
};
